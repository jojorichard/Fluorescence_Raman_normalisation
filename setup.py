...
setup(
    ...
    maintainer='Premier Auteur, Deuxième Auteur, Jonas Richard',  
    maintainer_email='premier.auteur@example.com, deuxieme.auteur@example.com, jonas.richard@hotmail.fr', 
